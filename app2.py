...
if prompt :=st.chat_input("whats up?"):
    ...
    elif prompt == "You remember the black jeans i bought last month?":
        response1 = "Do you mean The Mango Dark shade, no fade, flared, mid-rise, black jeans?"
    elif prompt == "Yes that one":
        response1 = "How may i help you with it?"
    elif prompt == "What kind of tshirt should i wear with it?":
    ...
    elif prompt == "Which one will be the best for a casual outing?":
